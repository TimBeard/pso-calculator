import { CHARACTER_ARMOR_VALUE_IDS, CHARACTER_CLASS_IDS } from '@pso/shared'
...
const armorCatalogSchema = new Schema(
  {
    id: {
      type: String,
    ...
    bonuses: {
      type: statBonusesSchema,
      required: true,
    },
    conditionalEffects: {
      type: [conditionalEffectSchema],
      default: [],
      required: true,
    },
    compatibleClasses: {
...
armorCatalogSchema.index({ id: 1 }, { unique: true })

export const ArmorCatalogModel = model('ArmorCatalog', armorCatalogSchema)